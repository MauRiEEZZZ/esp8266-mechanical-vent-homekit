...
homekit_characteristic_t ch_timer_short_name = HOMEKIT_CHARACTERISTIC_(NAME, "5 min");
homekit_characteristic_t ch_timer_short_on = HOMEKIT_CHARACTERISTIC_(ON, false);

homekit_characteristic_t ch_timer_long_name = HOMEKIT_CHARACTERISTIC_(NAME, "40 min");
...
homekit_accessory_t *accessories[] = {
    ...
    HOMEKIT_ACCESSORY(.id=2, .category=homekit_accessory_category_switch, .services=(homekit_service_t*[]) {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
            HOMEKIT_CHARACTERISTIC(NAME, "Timer kort"),
            HOMEKIT_CHARACTERISTIC(IDENTIFY, my_accessory_identify),
            NULL
        }),
    ...
    HOMEKIT_ACCESSORY(.id=3, .category=homekit_accessory_category_switch, .services=(homekit_service_t*[]) {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
            HOMEKIT_CHARACTERISTIC(NAME, "Timer lang"),
            HOMEKIT_CHARACTERISTIC(IDENTIFY, my_accessory_identify),
            NULL
        }),
